...
for (i in 1:length(ancom.intersect$taxon)) {
  lt.graph.hfd %>% 
  filter(OTU == ancom.intersect$taxon[i]) %>%  
  ggplot(aes(x = Surgery, y = Abundance, color = Surgery)) + 
  geom_boxplot() + geom_point() +  
  labs(y="Relative Abundance", title = str_glue(ancom.intersect$taxon[i], " Relative Abundance, LT; Surgery"),
       x="Surgery") + 
...
for (i in 1:length(ancom.intersect$taxon)) {
  ...
  geom_boxplot() + geom_point() +  
  labs(y="Relative Abundance", title = str_glue(ancom.intersect$taxon[i], " Relative Abundance, LT; Intranasal Treatment"),
...
for (i in 1:length(ancom.intersect.nosurgery$taxon)) {
  ...
  ggplot(aes(x = Intranasal_Treatment, y = Abundance, color = Intranasal_Treatment)) + 
  geom_boxplot() + geom_point() +  
  labs(y="Relative Abundance", title = str_glue(ancom.intersect.nosurgery$taxon[i], " Relative Abundance, LT; Intranasal treatment"),
       x="Intranasal Treatment") + 
  theme_bw(base_size = 14) -> p
  print(p)
}
...
for (i in 1:length(ancom.intersect.nosurgery$taxon)) {
  ...
  geom_boxplot() + geom_point() +  
  labs(y="Relative Abundance", title = str_glue(ancom.intersect.nosurgery$taxon[i], " Relative Abundance, LT; Diet"),
       x="Diet") + 
  theme_bw(base_size = 14) -> p
  print(p)
}
